...
public struct ClientProperty : IFlatbufferObject
{
  ...
  public string TargetIP { get { int o = __p.__offset(14); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
  public ArraySegment<byte>? GetTargetIPBytes() { return __p.__vector_as_arraysegment(14); }
  public int TargetPort { get { int o = __p.__offset(16); return o != 0 ? __p.bb.GetInt(o + __p.bb_pos) : (int)0; } }
  ...
  public static void StartClientProperty(FlatBufferBuilder builder) { builder.StartObject(7); }
  ...
  public static void AddTargetIP(FlatBufferBuilder builder, StringOffset targetIPOffset) { builder.AddOffset(5, targetIPOffset.Value, 0); }
  public static void AddTargetPort(FlatBufferBuilder builder, int targetPort) { builder.AddInt(6, targetPort, 0); }
